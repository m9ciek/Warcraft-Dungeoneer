...
public class CharacterController {
    ...
    public ResponseEntity<Character> getCharacter(@PathVariable String name, @RequestParam String realm, OAuth2Authentication oAuth2Authentication) throws JsonProcessingException {
        ...
        ResponseEntity<String> response = blizzardApiService
                .requestBlizzardApi("https://eu.api.blizzard.com/profile/wow/character/" + realmCorrected + "/" + name.toLowerCase() + "?namespace=profile-eu&locale=en_US",
